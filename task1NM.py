...
#     companies.append({"name": stock_name,"number_shares": num_shares, "company_share_price": share_price})

 
#     stock_value = num_shares * share_price
#     total_value += stock_value


# print("The total value of the stock portfolio is", total_value)
# print(companies)
# print("Program ended.")
...
#     a.append({"name": patient_name, "price": patient_age})
...
#     b.append({"name": student_name, "age":student_age})
#     print("-" * 22)
# print(b)
# print("Program ended.")
...
#     restaurant.append({"prod_name": product_name, "prod_price":product_price}) 
#     print("-" * 22)
# print(restaurant)
# print("Program ended.")
...
#      technology.append({"prod_name": name, "prod_price":age, "prog_language":program_language}) 
#      print("-" * 22)
...
#    telecommunication.append({"tel_phone_name": phone_name, "tel_phone_price":phone_price})
#    print("-" * 30)
...
# wood_quantity = float(input("Enter the quantity of wood needed for one house: "))
# wood_cost = float(input("Enter the cost of one unit of wood: "))

# cement_quantity = float(input("Enter the quantity of cement needed for one house: "))
# cement_cost = float(input("Enter the cost of one unit of cement: "))

# sand_quantity = float(input("Enter the quantity of sand needed for one house: "))
# sand_cost = float(input("Enter the cost of one unit of sand: "))

# iron_quantity = float(input("Enter the quantity of iron needed for one house: "))
# iron_cost = float(input("Enter the cost of one unit of iron: "))

# total_cost = (wood_quantity * wood_cost) + (cement_quantity * cement_cost) + (sand_quantity * sand_cost) + (iron_quantity * iron_cost)

# print("Total cost of materials for construction project:", total_cost, "AZN")
